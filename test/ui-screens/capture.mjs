...
async function captureTheme(browser, theme, port) {
  ...
  try {
    ...
    const rowTargetIssues = await page.evaluate(() => Array.from(document.querySelectorAll(
      ".fp-gear-btn,.fp-del-btn,.fp-visibility-btn,.fp-dup-btn,.fp-type-icon,.fp-section-toggle,.fp-group-toggle,.lp-row-eye,.lp-row-clear,.lp-group-eye,.lp-layer-eye,.lp-row-op,.lp-row-menu,.lp-swatch,.lp-caret"
